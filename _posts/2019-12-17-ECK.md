...
This expresion is the defination of **KL divergence**, i.e.  measure of how one probability distribution (P) is different from a second(Q), reference probability distributionhow much the data is from distribution p rather than q. 
