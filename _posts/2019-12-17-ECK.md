...
When compare to _eqation 1_ Cross-Entropy is: \\[H(p,q) = \sum\limits_{i=1}^n p(x_i) * \log q(x_i)\\] 

Now, we have all the terms:  <font size='4'> __Entropy, Cross-Entropy and KL divergence.__ </font>