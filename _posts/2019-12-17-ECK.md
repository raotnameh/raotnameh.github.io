...
This expresion is the defination of **KL divergence**, i.e.  measure of how one probability distribution (q) is different from a second(p), reference probability distributionhow.  
