...
Therefore Entropy or Uncertainity can be defined as \\(-log(A)\\). But, in Machine Learning (ML) we use Expectation of an event therefore multiply it with the probability of the event. Therefore, Expectation of entropy is:  \\[-A * log(A)\\]
