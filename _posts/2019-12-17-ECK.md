...
I'm gonna define the individual terms first and then will explaing them in detail. so please, ear with me.  

Cross-Entropy = It measures the distance or similarity between two distribution and in the ML case Probability distribution.  
