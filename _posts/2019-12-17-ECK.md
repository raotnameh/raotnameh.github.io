...
Since KL divergence is gain or loss of information when we move between probability distribution p and q.
...
This expresion is the defination of **KL divergence**, i.e. how much the data is from distribution p rather than q. Since KL divergence is gain or loss of information when we move between probability distribution p and q.
