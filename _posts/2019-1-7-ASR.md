...
* Acoustic Model and,
* Language Model <br />
The acoustic model is responsible for calculating the \\(P(O / W) \\) and the language models come into the picture to make sense out of predicted word sequence.  
