...
\\(P(o / w) \\): It means, given the observed word sequence w, the one Probability density function (PDF) \\(f(x / \\theta) \\) among all the PDF's that are most likely to have produced the data. what do i mean by all the other PDF's can be seen in Fig. 1.
<br />
