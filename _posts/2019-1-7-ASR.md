...
<br />
<br />
what do I mean by all the other PDF's? Let's take an example of gaussian distribution. why? because it will be easy for us in the math department. The gaussian distribution formualtion and it's plot can be seen in Fig. 1. As shown in fig for different calues of \\(\\mu \\)
