...
WER: It's computed using "String edit distance" or "Levenstein distance."
...
### Spectrogram 
It's a better representation of an Audio signal, to fed to a Neural Network. There is a saying in Machine learning communty: __Good Features make problems TRIVIAL __
### Acoustic Model 
