...
__SER__: It's very simple to calculate. according tothe SER defination, even if a single word in a sentence is incorrect it wil label it as incorrect hypothesis. SER is used as _proportion of incorect sentences to the total number of sentences_.  
...
Language model also plays an importatn role when there is ambguity in the predictted text. for example, I *blank* you, if you have to choose between _NO_ and _KNOW_ which one whould you choose?
