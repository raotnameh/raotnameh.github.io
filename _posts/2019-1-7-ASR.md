...
WER: It's computed using "String edit distance" or "Levenstein distance." It's is \\[WER = (N<sub>sub</sub> + N<sub>ins</sub> + N<sub>del</sub>) / N<sub>ref</sub>\\]. Where,  
...
i.e. the no of substitutions, insertions and deletions of __WORDS__needed to get from the reference to hypothesis (ASR system best guess of the transcript).
