...
### Spectrogram 
It's a better representation of an Audio signal which combines both time and frequency information, to fed to a Neural Network. There is a saying in Machine learning communty: __Good Features make problems TRIVIAL__.
### Acoustic Model 
