...
For example: In japan: A tremor occurs at least every five minutes, and each year there are up to 2,000 quakes that can be felt by people.  
the chances of japan gettng stuck by an eartquake are very high compared to Israel (according to the [*list of countries by natural disaster risk*](https://en.wikipedia.org/wiki/List_of_countries_by_natural_disaster_risk))